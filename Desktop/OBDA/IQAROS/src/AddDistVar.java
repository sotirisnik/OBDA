...
public class AddDistVar {
	...
	public static void main(String[] args) throws Exception{
		...
		AddDistinguishedVariables addVar = new AddDistinguishedVariables();
		...
		ArrayList<Clause> result = addVar.computeAddDistVar(tBoxAxioms, originalQuery, 2);
