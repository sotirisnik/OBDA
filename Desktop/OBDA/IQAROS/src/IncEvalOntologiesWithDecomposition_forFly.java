...
public class IncEvalOntologiesWithDecomposition_forFly {
...
//		runTest(ontologyFile, queryPath, optPath, dbPath, true, 0, print2Excel);
//		
//		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/LUBM/IQAROS/LUBMDB.xlsx";
//
//		addon="-ex";
//		/**
//		 * LUBM-ex Tests
...
//		System.out.println("**************************");
//		runTest(ontologyFile, queryPath, null, dbPath, true, 30, print2Excel);
//
//		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/UOBM/IQAROS/DB/DB-NAIVE.xlsx";
//		/**
//		 * Semintec Tests
//		 */
...
//		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/reactome/reactome(20160411).xlsx";
...
//		dbPath = "jdbc:postgresql://127.0.0.1:5432/FlyWithURIs";
		...
		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/Fly/IQAROS/DB/Fly_onIMac.excel";
...
//		runTest(ontologyFile, queryPath, null, dbPath, true, 0, true);
//		
//		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/Chembl/IQAROS/DB/Chembl_test.xlsx";
//
//
//		/**
//		 * Uniprot tests
...
//		runTest(ontologyFile, queryPath, optPath, dbPath, true, 0, print2Excel);
//		
//		excelFile = "/Users/avenet/Academia/Aueb/Research/IncrementalQueryAnswering/EvaluationResults/Uniprot/IQAROS/DB/Uniprot.xlsx";
...
//    	System.out.println("EVALUATION INITIALIZED");
		...
		for( int i=0 ; i<queries.length ; i++ ) {
			if( queries[i] == null )
	        	...
	        	if (!queries[i].toString().contains("2"))
	        		continue;
...
//	        	start = System.currentTimeMillis();
	        	...
	        	rewriting = incremental.computeUCQRewriting(tBoxAxioms,new ClauseParser().parseClause("Q(?0) <- FBbt_00005106(?0), RO_0002131(?0,?1)"), print);
...
//
	        	 ...
	        	 * DB evaluation
	        	 */
	        	Set<String> rewRes = new HashSet<String>();
	        	if ( rewriting.size() != 0 )
	        	{
	        		System.out.println("Evaluating rewriting...");
	        		rewRes = ev.evaluateSQLReturnResults( null, ev.getSQL( rewriting ));
	        		System.out.println(rewRes.size());
	        	}

	        	for(String str: rewRes)
	        		System.out.println(str);

	        	System.out.println("Evaluating rewriting...");
	        	ArrayList<Clause> rewriting2 = incremental.computeUCQRewriting(tBoxAxioms,new ClauseParser().parseClause("Q(?0) <- develops_from(?0,?2), FBbt_00067346(?2)"), print);
	        	Set<String> rewRes2 = ev.evaluateSQLReturnResults( null, ev.getSQL( rewriting2 ));
	        	System.out.println(rewRes2.size());
	        	for(String str: rewRes2)
	        		System.out.println(str);
	        	
	        	System.out.println("Common answers are : " + keepCommonAnswers(rewRes2, rewRes).size());
...
//		System.out.println( "Rew time = " + totalTime );
	...
	private static Set<String> keepCommonAnswers( Set<String> ans1, Set<String> ans2 ) {
		Set<String> res = new HashSet<String>();
		
		for (String str1: ans1)
			if (ans2.contains(str1))
				res.add(str1);
