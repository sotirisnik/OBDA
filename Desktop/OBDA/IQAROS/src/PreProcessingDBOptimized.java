...
public class PreProcessingDBOptimized {
...
//		String ontologyFile = "file:" + path + "biopax-level3-processed.owl";
		String ontologyFile = "file:" + path + "biopax-level3-processed_DL-Lite_mine.owl";
...
//		String optimizationPath = path + "/OptimizationClauses/optimizationClauses-new.txt";
//		String optimizationPath = path + "/OptimizationClauses/optimizationClauses-new-noTrans.txt";
		String optimizationPath = path + "/OptimizationClauses/optimizationClausesbiopax-level3-processed_DL-Lite_mine.txt";
        ...
        Evaluator ev = new Evaluator("jdbc:postgresql://127.0.0.1:5432/reactome");
...
//			System.out.println("2: " + str.substring((str.indexOf("----IQAROS---")+13), str.length()));
			result.add(str.substring((str.indexOf("----IQAROS---")+13), str.length()));
		}
		return result;
	}
