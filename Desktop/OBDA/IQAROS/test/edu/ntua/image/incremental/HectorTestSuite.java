...
public class HectorTestSuite extends TestCase {
	...
	public HectorTestSuite(String name) {
		super( name );
...
//		inc = new Incremental( c);
    ...
    public void testVOntology() throws Exception {
    	...
    	/**		Q1	**/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/V/Q1.txt"));
        assertEquals(15, result.size());
        
        /**		Q2	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/V/Q2.txt"));
        assertEquals(10, result.size());
        
        /**		Q3	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/V/Q3.txt"));
        assertEquals(72, result.size());
        
        /**		Q4	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/V/Q4.txt"));
        assertEquals(185, result.size());
        
        /**		Q5	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/V/Q5.txt"));
    ...
    public void testSOntology() throws Exception {
        ...
        /**		Q2	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/S/Q2.txt"));
        assertEquals(2, result.size());
        
        /**		Q3	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/S/Q3.txt"));
        assertEquals(4, result.size());
        
        /**		Q4	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/S/Q4.txt"));
        assertEquals(4, result.size());
        
        /**		Q5	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/S/Q5.txt"));
    ...
    public void testUOntology() throws Exception {
        ...
        /**		Q2	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/U/Q2.txt"));
        assertEquals(1, result.size());
        
        /**		Q3	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/U/Q3.txt"));
        assertEquals(4, result.size());
        
        /**		Q4	*/
        result = inc.computeUCQRewriting(tBoxAxioms,parser.getQuery(path + "Queries/U/Q4.txt"));
        assertEquals(2, result.size());
