...
public class HectorTestSuiteAddDistVarCGLLR extends TestCase {
	...
	AddDistinguishedVariablesCGLLR addV;
	
	public HectorTestSuiteAddDistVarCGLLR(String name) {
		super( name );
//		Configuration c = new Configuration();
//		c.redundancyElimination=RedundancyEliminationStrategy.Full_Subsumption;
////		inc = new Incremental( c);
//		inc = new Incremental( );
		addV = new AddDistinguishedVariablesCGLLR();
	}
